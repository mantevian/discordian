...
import xyz.mantevian.discordian.DiscordUtil.sendDeathMessage
import xyz.mantevian.discordian.DiscordUtil.sendLeaveMessage
import xyz.mantevian.discordian.kord.KordManager
	...
	override fun onInitializeServer() {
		...
		ServerLivingEntityEvents.AFTER_DEATH.register { entity, _ ->
			if (entity is ServerPlayerEntity) {
				sendDeathMessage(entity.getDamageTracker().deathMessage.string)
			}
		}
	}
